...
def test_load_dataset_remote():
    ...
    assert type(load_dataset('https://github.com/alan-turing-institute/scivision-test-data', branch='test-branch-dont-delete')) == intake.catalog.local.YAMLFileCatalog
