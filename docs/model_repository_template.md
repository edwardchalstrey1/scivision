...
This is also a pre-requisite for adding the model to the scivision "catalog", enabling other users of scivision to use it. To learn how to do this, read :ref:`extending-the-scivision-catalog` after setting up your model as per this guide.
