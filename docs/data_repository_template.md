...
This is also a pre-requisite for adding the dataset to the scivision "catalog", enabling other users of scivision to use it. To learn how to do this, read :ref:`extending-the-scivision-catalog` after setting up your data repo as per this guide.
